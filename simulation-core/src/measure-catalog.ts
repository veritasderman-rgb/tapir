...
export const MEASURE_CATALOG: GameMeasure[] = [
  ...
  // ═══════════════════════════════════════════
  // TRUST-BUILDING & GOVERNANCE (inspired by Israel's COVID response)
  // ═══════════════════════════════════════════
  {
    id: 'opposition_briefing',
    name: 'Pravidelný briefing opozice',
    category: 'economic',
    description: 'Pravidelné informování opozice o krizové situaci. Nákladné na čas, ale zvyšuje důvěru a legitimitu opatření.',
    npiEffect: { type: NPIType.BetaMultiplier, value: 1.0 },
    politicalCostPerTurn: -4, // builds trust
    economicCostPerTurn: 0.01,
    rampUpDays: 0,
    complianceDecayRate: 0,
    unlockCondition: { type: 'always' },
  },
  {
    ...
    category: 'economic',
    description: 'Denní tiskové konference s přímými daty. Izraelský model — otevřenost zvyšuje důvěru i za cenu krátkodobého šoku.',
  ...
  },
  {
    ...
    category: 'economic',
    description: 'Spolupráce s místními autoritami, náboženskými lídry a influencery na šíření informací. Izraelský přístup k ultra-ortodoxním komunitám.',
  ...
  },
  {
    ...
    category: 'economic',
    description: 'Otevřená data o epidemii v reálném čase. Inspirováno izraelským datovým přístupem — zvyšuje důvěru a zpřesňuje odhady.',
    npiEffect: { type: NPIType.BetaMultiplier, value: 1.0 },
    politicalCostPerTurn: -1,
    economicCostPerTurn: 0.01,
    rampUpDays: 14,
  ...
  },
  {
    ...
    category: 'economic',
    description: 'Telefonní linky pomoci, podpora duševního zdraví. Snižuje sociální únavu z opatření.',
    npiEffect: { type: NPIType.BetaMultiplier, value: 1.0 },
    politicalCostPerTurn: -2,
