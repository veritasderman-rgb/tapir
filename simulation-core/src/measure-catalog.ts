...
export const MEASURE_CATALOG: GameMeasure[] = [
  ...
  },
  {
    ...
    category: 'social_distancing',
    description: 'Zákaz kulturních, sportovních a společenských akcí nad 10 osob. Citelně omezí superspreader eventy (koncerty, zápasy, svatby), ale zasáhne kulturní a event průmysl.',
  ...
  },
  {
    ...
    name: 'Uzavření restaurací a barů',
    category: 'social_distancing',
    description: 'Zavření vnitřních prostor restaurací, barů a kaváren. Výrazně omezí kontakty v rizikovém prostředí (bez roušek, hlučné prostředí = aerosoly). Povoleny výdejní okénka.',
    npiEffect: { type: NPIType.ContactSubMatrixModifier, value: 0.75, targetSubMatrix: 'community' },
    politicalCostPerTurn: 6,
    economicCostPerTurn: 0.18,
    rampUpDays: 1,
    complianceDecayRate: 0.004,
    unlockCondition: { type: 'always' },
  },
  {
    id: 'retail_restrictions',
    name: 'Omezení maloobchodu',
    category: 'social_distancing',
    description: 'Uzavření neesenciálních obchodů (móda, elektronika, hobby). Otevřeny zůstávají potraviny, lékárny, drogerie. Redukuje kontakty v uzavřených prostorách.',
    npiEffect: { type: NPIType.ContactSubMatrixModifier, value: 0.6, targetSubMatrix: 'community' },
    politicalCostPerTurn: 7,
    economicCostPerTurn: 0.25,
    rampUpDays: 2,
    complianceDecayRate: 0.003,
    unlockCondition: { type: 'deaths_above', threshold: 50 },
  },
  {
    id: 'curfew',
    name: 'Noční zákaz vycházení',
    category: 'social_distancing',
    description: 'Zákaz vycházení od 21:00 do 05:00. Omezí noční setkávání a nelegální večírky. Epidemiologický efekt je středně velký, ale symbolicky silný.',
    ...
    unlockCondition: { type: 'deaths_above', threshold: 200 },
  },
  {
    id: 'senior_isolation',
    name: 'Ochrana seniorů (izolace)',
    category: 'social_distancing',
    description: 'Doporučení pro seniory k omezení kontaktů. Rozvoz nákupů, vyhrazené hodiny v obchodech. Chrání nejzranitelnější, ale sociální izolace má psychické dopady.',
    npiEffect: { type: NPIType.BetaMultiplier, value: 0.93 },
  ...
  {
    id: 'border_control',
    name: 'Kontroly na hranicích',
    category: 'social_distancing',
    description: 'Povinné testy při vstupu do země, karanténa pro příchozí ze zasažených oblastí. Zpomalí import nových variant, ale komplikuje mezinárodní obchod a dopravu.',
  ...
  {
    id: 'public_transport_limits',
    name: 'Omezení MHD kapacity',
    category: 'social_distancing',
    description: 'Snížení kapacity veřejné dopravy na 50 %, posílení intervalů. Redukuje kontakty v uzavřeném prostředí, ale komplikuje dopravu do práce.',
    npiEffect: { type: NPIType.ContactSubMatrixModifier, value: 0.85, targetSubMatrix: 'work' },
    politicalCostPerTurn: 4,
    economicCostPerTurn: 0.08,
    rampUpDays: 3,
    complianceDecayRate: 0.002,
