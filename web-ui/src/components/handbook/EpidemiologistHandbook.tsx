  ...
  return (
    <>
      ...
      <ul className="space-y-2 text-sm text-gray-700">
        ...
        <li><strong>Kapacita</strong> — jeden hygienik/hygienička zvládne vytrasovat 5–10 případů denně. Při explozivním nárůstu počet případů rychle přeroste kapacitu trasovacích týmů.</li>
      </ul>
    </>
  );
}
