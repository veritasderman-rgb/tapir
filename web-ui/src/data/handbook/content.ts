  ...
  // ════════════════════ PŘÍBĚH ════════════════════
  {
    ...
    content: {
      ...
      ss: [
        ...
        { t: 'h', text: 'Na to ale není sama' },
        { t: 'p', html: 'Tady je důležité vidět, že vyšetřování není práce jednoho člověka. Postupně se zapojí celý tým:' },
        { t: 'list', items: [
          '<strong>Lékař v nemocnici</strong> léčí pacienty a hned na začátku odebral vzorky — bez nich by nebylo co zkoumat.',
          '<strong>Laboratoř</strong> ze vzorků určí původce a potvrdí, že jde u všech o tu samou bakterii či virus.',
          '<strong>Potravinová inspekce</strong> (SZPI) zkontroluje výrobnu a šarži, odkud salát pochází.',
          '<strong>Hygienici</strong> obvolávají hosty, vyplňují dotazníky a hlídají, jestli nepřibývají další nemocní.',
        ] },
        { t: 'h', text: 'A není to jen u nás' },
        { t: 'p', html: 'Během pár dní začnou hlásit podobné případy i <strong>z jiných měst</strong> — od lidí, kteří na žádné svatbě nebyli. Když se to zanese do mapy, ukáže se, že nejde o jedno místo: ten samý výrobek se totiž <strong>rozvážel i do dalších krajů</strong>. Z místního problému se stává problém na více místech najednou — a řešit ho musí víc hygienických stanic dohromady, ne jen ta jedna Kovářové.' },
        { t: 'h', text: 'Krok 4 — Rozhodnout pod tlakem' },
        { t: 'p', html: 'A tady přichází dilema, které poznáte i ve hře. Laboratorní potvrzení přijde za tři dny. Počkat na jistotu — nebo <strong>jednat hned</strong> a varovat veřejnost, stáhnout výrobek, i kdyby se nakonec ukázalo, že šlo o planý poplach? Kovářová ví, že každý den čekání může znamenat další nemocné. Rozhodne se jednat — opatrně, ale hned. Výrobek se stáhne z prodeje a během pár dní nové případy ustanou.' },
        { t: 'info', title: 'Proč příběh', html: 'Za čísly v modelech jsou vždycky <strong>skutečná rozhodnutí konkrétních lidí</strong> — pod tlakem, s neúplnými daty a s odpovědností za následky. Epidemiologie není jen matematika; je to řemeslo, detektivní práce a týmová spolupráce zároveň. Přesně tu kombinaci si zkoušíte ve všech hrách platformy.' },
      ],
      vs: [
        ...
        { t: 'p', html: 'Z <strong>národní referenční laboratoře</strong> (při Státním zdravotním ústavu) přichází průlom. Kultivace a PCR potvrdí konkrétní agens; protože jde o virus, laboratoř pustí i <strong>celogenomovou sekvenaci</strong>. A právě sekvence promění klinické podezření v důkaz: izoláty od nemocných z různých rodin jsou <strong>geneticky prakticky totožné</strong> — patří do jednoho klonu. To je silný argument pro jediný společný zdroj, nikoliv pro náhodný souběh několika nezávislých nákaz. Laboratoř tu „doplňuje" terén: bez ní bychom měli jen příběh, teď máme i otisk prstu.' },
        { t: 'p', html: 'A pak přijde věc, která Kovářové zvedne obočí. Do referenční laboratoře začnou ze systému docházet i izoláty z <strong>jiných krajů</strong> — a sekvence sedí na stejný klon. To je první tvrdý signál, že nejde o lokální průšvih po jedné slavnosti: <strong>stejný kmen se objevuje na místech, která spolu na první pohled nesouvisejí</strong>. Z okresního ohniska se rázem stává něco mnohem většího.' },
        ...
        { t: 'p', html: 'Souběžně se potvrzuje to, co naznačila středeční laboratoř. Hygienici v sousedním i ve vzdálenějším kraji hlásí <strong>vlastní menší shluky</strong> — lidé, kteří na žádné slavnosti nebyli. Když se případy zanesou do mapy, přestává to vypadat jako jedno ohnisko a začíná to připomínat <strong>rozeseté body podél jedné distribuční trasy</strong>. Společným jmenovatelem napříč kraji je tentýž dodavatel.' },

        { t: 'h', text: 'Pátek — eskalace a koordinace' },
        { t: 'p', html: 'Case-control studie i mapa ukazují stejným směrem: silná vazba na jeden konkrétní výrobek od regionálního dodavatele, který ho rozváží do několika krajů i do zahraničí. Tím případ definitivně přerůstá hranice okresu a stává se z něj <strong>vícekrajové (a možná mezinárodní) ohnisko</strong>. Kovářová svolává <strong>koordinační schůzku</strong>: přebírá to ústřední úroveň (SZÚ, hlavní hygienik / ministerstvo), propojují se dotčené KHS, aby všichni používali stejnou definici případu a sdíleli data, a vzhledem k distribuci za hranice se podává hlášení do evropského systému včasného varování (a tím k <strong>ECDC</strong>). Kdyby vyvstalo podezření na úmyslnou kontaminaci nebo bylo potřeba zajistit zboží proti vůli provozovatele, přizvala by se <strong>Policie ČR</strong>. Zároveň běží <strong>komunikace s veřejností</strong> napříč zasaženými regiony — jasné varování, ať lidé výrobek nekonzumují a vrátí ho.' },

        { t: 'h', text: 'Víkend — zásah a kontrola' },
        { t: 'p', html: 'Přichází rozhodující krok, který se musí provést <strong>plošně, ne jen lokálně</strong>: celostátní <strong>stažení šarže</strong> z trhu, uzavření provozu do nápravy a dohledání všech odběratelů napříč kraji. Na epidemických křivkách jednotlivých regionů se to projeví se zpožděním daným inkubační dobou — nové případy během několika dní ustávají všude naráz, což je samo o sobě potvrzením, že zdroj byl ten správný. Kovářová s ústředním týmem sepisuje závěrečnou zprávu: co se stalo, jak se to potvrdilo, co zabralo a co příště udělat jinak. Ohnisko je zvládnuté — nikoliv proto, že by jeden chytrý epidemiolog „vyřešil záhadu", ale proto, že na sebe napříč republikou navázalo několik týmů.' },
