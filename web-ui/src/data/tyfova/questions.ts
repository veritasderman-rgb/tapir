...
export const questions: TyfovaQuestion[] = [
  ...
  // ===== STEP 5: Identifikace zdroje =====
  {
    ...
    type: 'multiple_choice',
    options: [
      'Charles Warren — protože onemocněl jako první muž',
      'Margaret Warren — protože onemocněla jako první',
      'Mary Mallon — kuchařka, která připravila zmrzlinu a je zdravá',
      'Patrick — zahradník, který má vlastní kuchyňku',
    ],
    correctAnswer: 'Mary Mallon — kuchařka, která připravila zmrzlinu a je zdravá',
    explanation:
